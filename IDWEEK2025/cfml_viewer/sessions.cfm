...
<cfparam name="url.table" default="IDWEEK_2025">
<cfparam name="url.rawField" default="sessionData">
...
<cfoutput query="getAllIDWEEKSessionData">
    <div style="background: ##ccffcc; padding: 5px; margin: 5px 0; border: 2px solid ##009900; font-weight: bold; font-size: 16px;">
        🏛️ SESSION ID: #getAllIDWEEKSessionData.id# (URL param thisID: #url.thisID#)
    </div>
...
<div style="background: #e6ffe6; padding: 10px; margin: 10px 0; border: 1px solid #00cc00;">
